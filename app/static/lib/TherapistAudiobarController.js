...
TherapistAudiobarController.prototype.emitNewSettings = function () {
	fetch("/therapist/settings", {
		method: "POST",
		credentials: "include",
		body: JSON.stringify(this.audiobar),
	});
};

TherapistAudiobarController.prototype.handleInitialSettings = function (
	initialSettings
) {
...
TherapistAudiobarController.prototype._updateSpeed = function () {
	...
	const newSpeed =
		(this.maxSpeed - this.minSpeed) * percentage + this.minSpeed;
	this.audiobar.setSpeed(newSpeed);
};

TherapistAudiobarController.prototype.handlePitchClick = function (
	buttonClicked
) {
...
export default TherapistAudiobarController;
